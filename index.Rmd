...
[Link to presentation](https://github.com/S-Leuthold/1_rmarkdown_examples/index2.html)
...
The Poudre river is a *key* source of water to the Northern Colorado region. The hydrologic processes that determine discharge are characteristic of streams that receive mountain block recharge in in the semi-arid west ([Foy et al, 2015](https://ascelibrary.org/doi/pdf/10.1061/%28ASCE%29HE.1943-5584.0001130)). However, with **changing climatic norms** such as decreased winter snow pack and an increased prevalence of rain on snow events, the Poudre is at an increased risk of sustained drought conditions ([Salas et al., 2005](https://ascelibrary.org/doi/pdf/10.1061/%28ASCE%290733-9496%282005%29131%3A5%28383%29)). Figure 1 shows the daily discharge of the Poudre over the last **5** years. The a pattern of decreased peak flow during snowmelt periods is further indicative of changing hydrologic regimes. An interesting aside is the short lived secondary peak in flow that happens annually between September and October, *possibly* due to a shift in water usage, though this bump is also observable at the [mouth of Poudre Canyon](https://dwr.state.co.us/Tools/Stations/CLABOXCO?params=DISCHRG).
